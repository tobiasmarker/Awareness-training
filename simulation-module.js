  ...
  function initSimulation(containerId){
    ...
    var scenarios = {
      ...
      follow_up_call: {
        ...
        content: "A caller claiming to be from the vendor's finance team says the bank change must be processed before the cut-off. They insist the finance director is unavailable and ask you to keep things moving.",
      ...
      teams_message: {
        ...
        content: "Hi, sorry to drop this on you. I'm locked out of the shared drive and need the latest client payment tracker before a meeting.",
        detail: "A Teams message appears while you are working. The profile looks familiar, and the request sounds plausible.",
      ...
      fake_onedrive: {
        ...
        content: "You receive a file-sharing alert saying that a protected document is waiting for review. The page asks you to sign in before you can open the file.",
        detail: "The branding is convincing. The page looks almost identical to a normal Microsoft sign-in flow.",
        highRiskContent: "Because your risk level is already elevated, the prompt shows a realistic company-branded background and a recent document name to make the request more persuasive.",
        choices: [
          {
      ...
      calendar_invite: {
        ...
        content: "A calendar invite titled \"Mandatory Policy Review\" arrives with a link to an external document. The note says it must be completed today to avoid a compliance issue.",
        ...
        choices: [
          ...
          {
            text: "Check the sender and access the policy through the internet",
            effect: { securityScore: 20, riskLevel: -20, timePressure: -5 },
            next: "ending"
          },
          {
      ...
      ending: {
        ...
        content: "Your decisions shaped the final outcome. Review the result below before replaying the exercise.",
        choices: []
      }
    };
      ...
      return (
        "<div class=\"sim-module__header\">" +
          "<div>" +
            ...
            "<div class=\"sim-module__subtitle\">This exercise shows how early decisions can raise risk and make later social engineering attempts more persuasive.</div>" +
          "</div>" +
    ...
    function renderEnding(){
      ...
      return (
        "<div class=\"sim-module__ending fade-in\">" +
          ...
          "</div>" +
          "<div class=\"sim-module__detail\">Decision path: " + state.history.map(function(entry){ return entry.scenario + " -> " + entry.choice; }).join(" | ") + "</div>" +
    ...
    function simulateChatIntro(){
      ...
      overlay.innerHTML =
        "<div class=\"sim-module__overlay-card\">" +
          ...
          "<div class=\"sim-module__overlay-text\">Incoming internal Teams message...</div>" +
        "</div>";
    ...
    function showCallOverlay(){
      ...
      overlay.innerHTML =
        "<div class=\"sim-module__overlay-card\">" +
          ...
          "<div class=\"sim-module__overlay-text\">A caller is waiting and sounds urgent.</div>" +
        "</div>";
      panel.appendChild(overlay);
